...
urlpatterns = [
    ...
    path('api/me/organizations/', api.UserOrganizationsAPI.as_view(), name='user-organizations'),
    path('api/me/active-organization/', api.ActiveOrganizationAPI.as_view(), name='user-active-organization'),
]
